...
['ـها verb + ha', 'her'], 
['ـنا verb + na', 'us 2'], 
['ـكما verb + kuma', 'you 2'], 
['ـهما verb + huma', 'them 2'], 
['ـنا verb + na', 'us 3'], 
['ـكم verb + kum', 'you 3m'], 
['ـكن verb + kunna', 'you 3f'], 
['ـهم verb + hum', 'them 3m'], 
['ـهن verb + hunna', 'them 3f']
]
...
phil_aristotle_organon_general = [
    ...
    ['The following 6 works of Aristotle were compiled into his Organon: \n Categories, On Interpretation, Prior Analytics, Posterior Analytics, Topics, Sophistical Refutations. \nHowever, which of Aristotle his works were included extra in the Organon in the Islamic world? Answer: p.. r.. .', 'poetics rhetoric'],
...
phil_arab = [
    ...
    ["Works on Aristotle's Organon were translated into Syriac/Arabic, per period (AD): \n500-800: Isagoge, Categories, On Interpretation, P.. Analytics I 1-7 \n800-900 Kindi’s circle: whole Organon (fragmentary). \n900-1000 P.. Analytics, Poetics; And: older translations revised into the'Arabic Organon'.\n\nFill in the dots (2x).","prior posterior"],
    ["Works on Aristotle's Organon were translated into Syriac/Arabic, per period (AD): \n500-800: I.., Categories, On Interpretation, Prior Analytics I 1-7 \n800-900 Kindi’s circle: whole Organon (fragmentary). \n900-1000 Posterior Analytics, P..; And: older translations revised into the'Arabic Organon'.\n\nFill in the dots (2x).","Isagoge Poetics"],
    ["Works on Aristotle's Organon were translated into Syriac/Arabic, per period (AD): \n500-800: Isagoge, C.., On Interpretation, Prior Analytics I 1-7 \n800-900 K..’s circle: whole Organon (fragmentary). \n900-1000 Posterior Analytics, Poetics; And: older translations revised into the'Arabic Organon'.\n\nFill in the dots (2x).","Categories Kindi"],
    ...
    ["Logical treatises were written in A.., even by Turkic & Persian scholars. \nAlthough since 800 AD the whole organon was (fragmentarily) known, 'Arabic logic' remained focused on the p.. analytics; \neven after complete posterior analytics translations started circulating around 900. \n\nFill in the dots (2x).","arabic prior"],
    ["What is the Arabic for 'syllogism'?","qiyas"],
    ["What does the Arabic word 'qiyas' mean?","syllogism"],    
    ...
    ['Not only kalam, but in even more viewed as contrary to ... (=imitation) is ... , which is an Islamic legal term referring to independent reasoning or the exertion of a jurist his mental faculty in finding a solution to a legal question."\n\nFill in the dots (2x).','taqlid ijtihad'],
    ['The legal term that refers to independent reasoning or the thorough exertion of a jurist mental faculty in finding a solution to a legal question is ... . It was considered to be a religious duty for those qualified to perform it. \nAn Islamic scholar who is qualified to perform it, was called a ... . \nAfter ~1200 its scope of application became gradually limited. \n\nFill in the dots (2x) ijtihad',"taqlid mujtahid"],
    ...
    ["Al Farabi started with his 'Abridgement of Logic' a logical tradition that focused on 'analysis' (i.e. t..). \nWhich is: methods/heuristics for finding, given p, a proof of p or of its negation. \nThis tradition inspired Ibn S.. and also became lively in Andalusia. \nE.g. in the 12th c. by Ibn Bajja (Avempace) and the young Ibn Rushd (Averoes).\n\nFill in the dots(2x).","tahlil sina"],
    ["Al Farabi started with his 'Abridgement of Logic' a logical tradition that focused on 'analysis' (i.e. tahlil). \nTahlil = methods/heuristics for finding, given p, a p.. of p or of its negation. \nThis tradition inspired Ibn Sina and also became lively in Andalusia. \nE.g. in the 12th c. by Ibn B.. (Avempace) and the young Ibn Rushd (Averoes).\n\nFill in the dots(2x).","proof Bajja"],
    ['..., who lived around 1000 AD, could as a child not understand the Metaphysics until he read al-Farabi his commentary on it.','ibn sina'],
    ["Early Islamic metaphysics distinguishes more clearly than Aristotelianism between essence and existence. \nWhereas e.. is the domain of the contingent and the accidental, e.. endures within a being beyond the accidental. \nThe search for a definitive Islamic philosophy separate from Occasionalism (all events are caused directly by God) can be seen in what is left of Ibn Sina's work. \n\nFill in the gaps (2x).","existence essence"],
    ["Early Islamic metaphysics distinguishes more clearly than Aristotelianism between essence and existence. \nWhereas existence is the domain of the contingent and the accidental, essence endures within a being beyond the accidental. \nThe search for a definitive Islamic philosophy separate from o...sm (i.e. all events are caused directly by God) can be seen in what is left of Ibn Sina's work. \n\nFill in the gaps (1x).","Occasionalism"],
    ["Ibn Sina introduced modality propositions with a distinction between 2 types of necessity: \n(1) w.. (by description) necessity, and \n(2) dhati (e..) necessity. \n\nFill in the dots (2x).","wasfi essential"],
    ["Ibn Sina introduced modality propositions with a distinction between 2 types of necessity: \n(1) wasfi (by d..) necessity, and \n(2) d.. (essential) necessity. \n\nFill in the dots (2x).","description dhati"],
    ["Avicenna: metaphysical structures of necessity and contingency are different. \nThe necessary, being due to itself (wajib al-wujud bi-dhatihi), is 'true in i..', while the contingent is 'false in itself' and 'true due to something else other than itself'. \nThe necessary is the source of its o.. being without borrowed existence. \nIt is what always exists. \n\nFill in the gaps (2x).","itself own"],
    ["Avicenna: metaphysical structures of necessity and contingency are different. \nThe necessary, being d.. to itself (wajib al-wujud bi-dhatihi), is 'true in itself', while the contingent is 'false in itself' and 'true due to something else other than itself'. \nThe necessary is the source of its own being without borrowed existence. \nThe necessary is what a.. exists. \n\nFill in the gaps (2x).","due always"],
    ["Ibn Sina: The Necessary exists 'due-to-Its-Self', and has no quiddity/essence (m..) other than existence (w..).\n\nFill in the Arabic terms. (2x).","mahiyya wujud"],
    ["Ibn Sina: The Necessary is 'One' (w.. ahad) since there cannot be more than one 'Necessary-Existent-due-to-Itself' without differentia (f..) to distinguish them from each other. \n\nFill in the Arabic terms.","wahid fasl"],
    ["Ibn Sina: For the Necessary to require differentia entails that they exist 'due-to-themselves' as well as 'due to what is other than themselves'; and this is contradictory. \nHowever, if no differentia distinguishes them from each other, then there is no sense in which these 'Existents' are not one and the same. \nAvicenna adds that the 'Necessary-Existent-due-to-Itself' has no genus (j..), nor a definition (hadd), nor a counterpart (nadd), nor an opposite (did), and is detached (bari) from matter (madda), quality (kayf), quantity (kam), p.. (ayn), situation (wad), and time (waqt). \n\nFill in the Arabic terms (2x).","jins place"],
    ["Ibn Sina: For the Necessary to require d.. entails that they exist 'due-to-themselves' as well as 'due to what is other than themselves'; and this is contradictory. \nHowever, if no differentia distinguishes them from each other, then there is no sense in which these 'Existents' are not one and the same. \nAvicenna adds that the 'Necessary-Existent-due-to-Itself' has no genus (jins), nor a definition (hadd), nor a counterpart (nadd), nor an opposite (did), and is d.. (bari) from matter (madda), quality (kayf), quantity (kam), place (ayn), situation (wad), and time (waqt). \n\nFill in the dots (2x).","differentia detached"],
    ["Ibn Sina's psychology and theory of knowledge influenced Albertus M.., while his m.. influenced the thought of Thomas Aquinas.\n\nFill in the dots (2x)","Magnus metaphysics"],
    ["Like other Arabic logicians, Ibn Sina writes the minor premise (containing the conclusion's s..) BEFORE the major premise (containing conclusion's p..). \n\nFill in the dots (2x).","subject predicate"],
    ["Like other Arabic logicians, Ibn Sina writes the m.. premise (containing the conclusion's subject) BEFORE the m.. premise (containing conclusion's predicate). \n\nFill in the dots (2x).","minor major"],
    ["Ibn Sina, and also other Arabic post-Avicennan (revisionist) logicians, held that if nothing satisfies the subject term in an A or ... sentence, then it is a false sentence. \nBecause they held that affirmative propositions have existential i.. . \n\nFill in the dots (2x).","I import"],
    ["Ibn Sina, and also other Arabic post-Avicennan (revisionist) logicians, held that if nothing satisfies the s.. term in an A or I sentence, then it is a false sentence. \nBecause they held that affirmative propositions have e.. import. \n\nFill in the dots (2x).","subject existential"],
    ["Ibn Sina's expansion of Aristotle's logic is based on the fact that descriptions apply at one t.. but not on another. \nWhich is obvious e.g. for 'laughing' but also in the external world of genera and species: a dead horse is no horse. \nSo terms carry some ref to time: e.g.: \nsubject B means 'thing that is a B at some time during its e..'. \n\nFill the dots (2x).","time existence"],
    ["Ibn Sina's expansion of Aristotle's logic is based on the fact that descriptions apply at one time but not on another. \nWhich is obvious e.g. for 'laughing' but also in the external world of g.. and species: a dead horse is no horse. \nSo terms carry some ref to time: e.g.: \nsubject B means 'thing that is a ... at some time during its existence'. \n\nFill the dots (2x).","genera B"],
    ["Ibn Sina's references to time in syllogistic terms in order of logical strength: \na-d = all the while it e..; \na-l = all the while it's a B; \na-m = sometime while it's a B; \na-t = sometime while it exists; \ne-d; \ni-...; \no-t. \n\nHere d means: daruri=necessary.\n\nFill in the dots (2x).","exists l"],
    ["Ibn Sina's references to time in syllogistic terms in order of logical strength: \na-d = all the while it exists; \na-l = all the while it's a B; \na-m = s.. while it's a B; \na-t = sometime while it exists; \ne-d; \ni-l; \no-t. \n\nHere d means: d..=necessary.\n\nFill in the dots (2x).","sometime daruri"],
    ["Ibn Sina's references to time in syllogistic terms in order of logical strength: \na-d = all the while it exists; \na-l = all the while it's a ...; \na-m = sometime while it's a B; \na-t = sometime while it exists; \ne-d; \ni-l; \no-t. \n\nHere d means: daruri=n...\n\nFill in the dots (2x).","B necessary"],
    ["For Ibn Sina, epistemology has to be baked into logic. \nThrough logic, we can gain NEW knowledge of: \n(1) a concept (t..), using definition; or \n(2) a fact, rationaly accepted on basis of other already known facts (t.. ~ascent), using syllogism. \nWe can't assent to a proposition before understanding it, so tasawwur must precede tasdiq. \nSome concepts we have already by nature and some facts are known without needing deduction. \n\nFill in the dots (2x).","tasawwur tasdiq"],
    ["For Ibn Sina, epistemology has to be baked into logic. \nThrough logic, we can gain NEW knowledge of: \n(1) a concept (tasawwur), using d.. ; or \n(2) a fact, rationaly accepted on basis of other already known facts (tasdiq ~ascent), using syllogism. \nWe can't assent to a proposition before understanding it, so tasawwur must p.. tasdiq. \nSome concepts we have already by nature and some facts are known without needing deduction. \n\nFill in the dots (2x).","definition precede"],
    ["Arabic logicians after Ibn Sina (e.g. Razi, Khunaji) also focussed on t.. and tasawwur. \nAnd they also believed in Avicenna's position that real definitions are practically impossible, \nso that at most we can obtain n.. definitions of things 'according to our understanding'. \n\nFill in the dots (2x).","tasdiq nominal"],
    ["Arabic logicians after Ibn Sina (e.g. Razi, Khunaji) also focussed on tasdiq and t... \nAnd they also believed in Avicenna's position that r.. definitions are practically impossible, \nso that at most we can obtain nominal definitions of things 'according to our understanding'. \n\nFill in the dots (2x).","tasawwur real"],
    ["Arabic logicians since Khunaji recognized De M..'s law. \nHowever, a coincidental disjunction did not entail an implicative, nor even a coincidental conditional. \nSo, contrary to modern logic: \nFalsity of antecedent was not sufficient for t.. of a conditional; \nnor was it believed that anything can follow from contradiction. \n\nFill in the dots (2x).","Morgan truth"],
    ["Arabic logicians since Khunaji recognized De morgan's law. \nHowever, a coincidental disjunction did not entail an implicative, nor even a coincidental c.. . \nSo, contrary to modern logic: \nFalsity of antecedent was not sufficient for truth of a conditional; \nnor was it believed that anything can follow from c.. . \n\nFill in the dots (2x).","conditional contradiction"],
    ["Revisionist post-avicennan Arabic logicians denied that the statement 'it might be: if not-Q then ...' is absurd. \nKhunaji even tried to prove this statement by means of a 3rd f.. hypothetical syllogism. \n\nFill in the dots (2x).","Q figure"],
    ["Revisionist post-avicennan Arabic logicians denied that the statement 'it might be: if n..-Q then Q' is absurd. \nK.. even tried to prove this statement by means of a 3rd figure hypothetical syllogism. \n\nFill in the dots (2x).","not Khunaji"],
    ["Contrary to Aristotle and Ibn Sina, later revisionist Arabic logicians recognized the ...th figure syllogism.\n\nFill in the number (1x)","4"],
    ["Contrary to Aristotle and also Ibn ..., later revisionist Arabic logicians recognized the 4th figure syllogism.\n\nFill in the dots (1x)","Sina"],
    ["The Arabic revisionist logicians came to use 2 readings for propositions: \nan e.. and an essentialist reading. \nThey deviced rules for in which cases which reading is logically more s.. . \n\nFill in the dots (2x).","externalist strong"],
    ["The Arabic revisionist logicians came to use 2 readings for propositions: \nan externalist and an e.. reading. \nThey deviced r.. for in which cases which reading is logically more strong. \n\nFill in the dots (2x).","essentialist rules"],
    ["Arabic revisionists used 2 readings for 'Every J is B': \n(1) E..: Every actual J in extra-mental existence is B; \n(2) Essentialist: Every actual J (if it exists) is B (if it e..).\n\nFill in the dots (2x).","Externalist exists"],
    ["Arabic revisionists used 2 readings for 'Every J is B': \n(1) Externalist: Every actual J in extra-m.. existence is B; \n(2) E.. : Every actual J (if it exists) is B (if it exists).\n\nFill in the dots (2x).","mental Essentialist"],
    ...
    ["Ibn Rushd argued against these departures from Aristotle by Ibn Sina: \n(1) combinatorial h.. syllogism \n(2) quantification of conditionals \n(3) modality propositions with distinction between 2 types of n..: wasfi (description) and dhati (essential). \n\nFill in the dots (2x).","hypothetical necessity"],
    ["Ibn Rushd argued against these departures from Aristotle by Ibn Sina: \n(1) combinatorial hypothetical syllogism \n(2) quantification of c.. \n(3) modality propositions with distinction between 2 types of necessity: w.. (description) and dhati (essential).  \n\nFill in the dots (2x).","conditionals wasfi"],
    ...
    ["Around 1300 AD some (e.g. Al T..) defended Ibn Sina against the uselessness of these post-Avicennan inventions: \n(1) prioritizing immediate implications of hypotheticals and the hypothetical syllogism \n(2) considering traditional contraposition not valid \n(3) that 1st figure sylls with possibility minors are not p.. (i.e. lack conclusions). \n(4) that the subject matter of logic is merely known concepts + ascents, not 2nd intentions. \n(5) making logic too formal: totally neglecting demonstration, dialectics, rhetoric etc. \n\nTusi's defence however did not prevent the standard Madrasa logic textbooks from being written by revisionists. \n\nFill in the dots (2x).","Tusi productive"],
    ["Around 1300 AD some (e.g. Al Tusi) defended Ibn Sina against the uselessness of these post-Avicennan inventions: \n(1) prioritizing i.. implications of hypotheticals and the hypothetical syllogism \n(2) considering traditional contraposition not valid \n(3) that 1st figure sylls with possibility minors are not productive (i.e. lack conclusions). \n(4) that the subject matter of logic is merely known concepts + ascents, not 2nd intentions. \n(5) making logic too formal: totally neglecting demonstration, dialectics, rhetoric etc. \n\nTusi's defence however did not prevent the standard M.. logic textbooks from being written by revisionists. \n\nFill in the dots (2x).","immediate Madrasa"],
    ["Around 1300 AD some (e.g. Al Tusi) defended Ibn Sina against the uselessness of these post-Avicennan inventions: \n(1) prioritizing immediate implications of hypotheticals and the hypothetical syllogism \n(2) considering traditional c.. not valid \n(3) that 1st figure sylls with possibility minors are not productive (i.e. lack conclusions). \n(4) that the subject matter of logic is merely known concepts + ascents, not 2nd i.. . \n(5) making logic too formal: totally neglecting demonstration, dialectics, rhetoric etc. \n\nTusi's defence however did not prevent the standard Madrasa logic textbooks from being written by revisionists. \n\nFill in the dots (2x).","contraposition intentions"],
    ]

phil_scholast = [
	["Medieval Monks worked on translating/copying logical works mostly from the followings authors (per time period (AD)): \n500-1000 = Roman authors = Logica ... \n1000-1150 = Boethius \n1150-1250 = Aristotle's Analytics = Logica ... \n1250+ = University Corpus = Both Combined. \n\nFill in the dots (2x).","Vetus Nova"],
	["Medieval Monks worked on translating/copying logical works mostly from the followings authors (per time period (AD)): \n500-1000 = R.. authors = Logica Vetus \n1000-1150 = Boethius \n1150-1250 = Aristotle's A..s = Logica Nova \n1250+ = University Corpus = Logica Vetus+Nova. \n\nFill in the dots (2x).","Roman Analytics"],
	["Medieval Monks worked on translating/copying logical works mostly from the followings authors (per time period (AD)): \n500-1000 = Roman authors: Cicero, Cassiodorus, P...y, Isodorus = L. Vetus \n1000-1150 = B...s \n1150-1250 = Aristotle's Analytics = Logica Nova \n1250+ = University Corpus = Logica Vetus+Nova. \n\nFill in the dots (2x).","Porphyry Boethius"],
...
logic_propositional = [ # please expand this further using my summary of the Barwise logic study book ch 1-8
    ...
    ["Modus Ponens = 'affirming the antecedent': \n\n'If P implies Q; and P is true. Therefore ... must also be true.' \n\nIt was first described by Theophrastus, who also described the hypothetical syllogism, \nwhich is described as d.. modus ponens. Fill in the dots (2x).","Q double"],
	["Modus Ponens = 'affirming the antecedent': \n\n'If P implies Q; and ... is true. Therefore Q must also be true.' \n\nIt was first described by Theophrastus, who also described the h.. syllogism, \nwhich is described as double modus ponens. Fill in the dots (2x).","P hypothetical"],
	["Modus Tollens = 'denying the consequent': \n\n'If P, then Q; and not Q. Therefore, ... P.' \n\nIt was first described by T.. . Fill in the dots (2x).","not Theophrastus"],	
...
cse_automata_theory = [
    ["Finite Automata (FA): \nFA are used to model communication p..s and electronic circuits. \n\nFill in the dots (1x).","protocols"],
    ["Finite Automata (FA): \nAn FA is a Formal System and remembers only a finite amount of information, which is represented by its s.., which changes in response to inputs. \n\nFill in the dots (1x).","state"],
    ["Finite Automata (FA): \nAn FA is a Formal System and remembers only a f.. amount of information, which is represented by its state, which changes in response to inputs. \n\nFill in the dots (1x).","finite"],
    ["Finite Automata (FA): \nFA are used for design and v.. of circuits and communication protocols, for text-processing applications, and are an important component of compilers.\n\nFill in the dots (1x).","verification"],
    ["Finite Automata (FA): \nFA are used for design and verification of circuits and communication protocols, for text-processing applications, and are an important component of c..s (i.e. a computer programms that translates source code from a high-level language to a lower level language, e.g. assembly, to create an e..ble program.\n\nFill in the dots (2x).","compilers executable"],
    ["Finite Automata (FA) Terminology: \nTransition = \nrule that tells how the s.. changes in response to inputs. \n\nFill in the dots (1x).","state"],
    ["Finite Automata (FA) Terminology: \nT.. = \nrule that tells how the state changes in response to inputs. \n\nFill in the dots (1x).","Transition"],
    ["Finite Automata (FA) Terminology: \nInput string = \na sequence of inputs, that starts in 'start' state and follows the t.. from each symbol.\n\nFill in the dots (1x).","transition"],
    ["Finite Automata (FA) Terminology: \nInput s.. = \na sequence of inputs, that starts in 'start' state and follows the transition from each symbol.\n\nFill in the dots (1x).","string"],
    ["Finite Automata (FA) Terminology: \nA.. input = \ninput that, after all inputs of the input string have been read, leads to a final state that is 'accepted'.\n\nFill in the dots (1x).","accepted"],
    ["Finite Automata (FA) Terminology: \nAccepted input = \ninput that, after all inputs of the input string have been read, leads to a f.. state that is 'accepted'.\n\nFill in the dots (1x).","final"],
    ["Finite Automata (FA) Terminology: \nL.. of automaton A = L(A) = \nthe set of input strings that are 'accepted' by A (i.e. that lead to an accepted final state).\n\nFill in the dots (1x).","Language"],
    ["Finite Automata (FA) Terminology: \nLanguage of automaton A = L(A) = \nthe set of input s.. that are 'accepted' by A (i.e. that lead to an accepted final state).\n\nFill in the dots (1x).","strings"],
    ["Regular Expressions (RE): \nRegular expressions describe the regular languages by an algebra. \nRE are e.g. used by UNIX (a.*b) and Document T.. Definitions (DTD)  \n\nFill in the dots (1x).","type"],
    ["Regular Expressions (RE): \nRegular expressions describe the regular languages by an a.. . \nRE are e.g. used by UNIX (a.*b) and Document Type Definitions (DTD)  \n\nFill in the dots (1x).","algebra"],
    ["Regular Expressions (RE): \nRegular expressions describe the regular l.. by an algebra . \nRE are e.g. used by UNIX (a.*b) and Document Type Definitions (DTD)  \n\nFill in the dots (1x).","languages"],
    ["Regular Expressions (RE): \nL(E) = the language that is defined by the ... ..., which is called E. \nM(F) = the language defined by the RE called F.\n\nFill in the dots (1x).","regular expression"],
    ["Regular Expressions (RE) Terminology: \nL(E) = is the language that is d.. by the RE, which is called E. \nM(F)= the language defined by the RE called F.\n\nFill in the dots (1x).","defined"],
    ["Regular Expressions (RE): \nRE's use 3 operations: \n(1) U.. = \n   {01,111,10} ∪ {00,01}={01,111,10,00} \n(2) Concatenation of L and M = every wx with w in L and x in M:\n   {01,111,10}{00,01}={0100,0101,11100,11101,1000,1001}\n(3) L*=K.. Star of language L= the strings formed by concatenating ≥0 strings from L, in any order: \n   {0,10}* = {ε,0,10,00,010,100,1010,etc}\n\nFill in the dots (2x).","Union Kleene"],
    ["Regular Expressions (RE): \nRE's use 3 operations: \n(1) Union = \n   {01,111,10} ∪ {00,01}={01,111,10,00} \n(2) C.. of L and M = every wx with w in L and x in M:\n   {01,111,10}{00,01}={0100,0101,11100,11101,1000,1001}\n(3) L*=Kleene Star of language L= the strings formed by concatenating ≥0 strings from L, in any order: \n   {...,10}* = {ε,0,10,00,010,100,1010,etc}\n\nFill in the dots (2x).","concatenation 0"],
    ["Regular Expressions (RE): \nRE's use 3 operations: \n(1) Union = \n   {01,111,10} ∪ {00,01}={01,111,10,...} \n(2) Concatenation of L and M = every wx with w in L and x in M:\n   {01,111,10}{00,01}={0100,01...,11100,11101,1000,1001}\n(3) L*=Kleene Star of language L= the strings formed by concatenating ≥0 strings from L, in any order: \n   {0,10}... = {ε,0,10,00,010,100,1010,etc}\n\nFill in the dots (3x).","00 01 *"],
    ["Context Free Grammar (CFG): \nCFG uses p.. rules to generate sentences / languages. \nCFG is used for syntax of programming languages & natural languages. \nCFG can define m.. languages than Finite Automata (FA) or Regular Expressions (RE), though not all possible languages. \n\nFill in the dots (2x).","production more"],
    ["Context Free Grammar (CFG): \nCFG uses production rules to generate sentences / languages. \nCFG is used for s.. of programming languages & natural languages. \nCFG can define more languages than Finite A.. (FA) or Regular Expressions (RE), though not all possible languages. \n\nFill in the dots (2x).","syntax automata"],
    ["Context Free Grammar (CFG): \nCFG are useful for nested structures, e.g. parentheses in programming languages. \nExample: The CFG for language {0^n 1^n|n>1} can be defined by the p..s: \nS->01 and S->0S1 \n\nFill in the dots (1x).","production"],
    ["Context Free Grammar (CFG): \nCFG are useful for nested structures, e.g. parentheses in programming languages. \nExample: The CFG for language {0^n 1^n|n>1} can be defined by the productions: \nS->01 and S->0...1 \n\nFill in the dots (1x).","S"],
    ["Context Free Grammar (CFG): \nCFG are useful for nested structures, e.g. parentheses in programming languages. \nExample: The CFG for language {0^n ...^n|n>1} can be defined by the productions: \nS->01 and S->0S1 \n\nFill in the dots (1x).","1"],
    ["Context Free Grammar (CFG) Terminology: \nT..s = \nsymbols of the alphabet of the language being defined, e.g. for language {0^n 1^n|n>1}, the alphabet is: {0,1}.\n\nFill in the dots (1x).","Terminals"],
    ["Context Free Grammar (CFG) Terminology: \nTerminals = \nsymbols of the alphabet of the language being defined, e.g. for language {0^n 1^n|n>1}, the alphabet is: {0,...}.\n\nFill in the dots (1x).","1"],
    ["Context Free Grammar (CFG) Terminology: \nVariables = non-terminals = \na finite set of other symbols, each of which represents a language. \nE.g. if you have production rule S->0S1, then {S} is a language represented by v.. S.\n\nFill in the dots (1x).","variable"],
    ["Context Free Grammar (CFG) Terminology: \nVariables = non-t...s = \na finite set of other symbols, each of which represents a language. \nE.g. if you have production rule S->0S1, then {S} is a language represented by variable S.\n\nFill in the dots (1x).","terminals"],
    ["Context Free Grammar (CFG) Terminology: \nS.. symbol = the variable whose language is the one being defined, i.e. S. \n\nFill in the dots (1x).","Start"],
    ["Context Free Grammar (CFG) Terminology: \nProductions have the form: \nvariable (=head) -> string of variables and terminals (=b..)\n\nFill in the dots (1x).","body"],
    ["Context Free Grammar (CFG) Terminology: \nConventions: \nA, B, C, and S are v...s .\na, b, c, are terminals. \nX, Y, Z are either terminals or variables. \nw, x, y, z are strings of terminals only. \nα, β, γ are strings of terminals and/or variables.\n\nFill in the dots (1x).","variables"],
    ["Context Free Grammar (CFG) Terminology: \nConventions: \nA, B, C, and S are variables. \na, b, c, are t...s . \nX, Y, Z are either terminals or variables. \nw, x, y, z are strings of terminals only. \nα, β, γ are strings of terminals and/or variables.\n\nFill in the dots (1x).","terminals"],
    ["Context Free Grammar (CFG) Terminology: \nConventions: \nA, B, C, and S are variables. \na, b, c, are terminals. \nX, Y, Z are either terminals or variables. \nw, x, y, z are s...s of terminals only. \nα, β, γ are strings of terminals and/or variables.\n\nFill in the dots (1x).","strings"],
    ["Context Free Grammar (CFG) Terminology: \nDerivation (i.e. => symbol) = \nE.g. αAβ => αγβ if ...->γ is a production. \nAnd =>* means ≥0 derivation steps. \n\nFill in the dots (1x).","A"],
    ["Context Free Grammar (CFG) Terminology: \nDerivation (i.e. => symbol) = \nE.g. αAβ => αγβ if A->γ is a production. \nAnd =>... means ≥0 derivation steps. \n\nFill in the dots (1x).","*"],
    ["Context Free Grammar (CFG) Terminology: \nSentential f.. = \nAny string of variables and/or terminals, derived from the start symbol S.\n\nFill in the dots (1x).","form"],
    ["Context Free Grammar (CFG) Terminology: \nS.. form = \nAny string of variables and/or terminals, derived from the start symbol S.\n\nFill in the dots (1x).","Sentential"],
    ["Context Free Grammar (CFG) Terminology: \nL(G) = the language of the CFG named G = {... | S =>* w}.   \n\nFill in the dots (1x).","w"],
    ["Context Free Grammar (CFG) Terminology: \nCFL = Context Free ... = ... defined by a Context Free Grammar (CFG).\n\nFill in the missing word (1x).","Language"],
    ["Context Free Grammar (CFG) Terminology: \nCFL = Context Free Language = language defined by a Context Free G.. (CFG).\n\nFill in the missing word (1x).","Grammar"],    
    ["Context Free Grammar (CFG): \nSome Context Free Languages (CFL) aren’t regular, meaning they cannot be defined by regular expressions. \nE.g.: {0^n 1^n | n ... 0}\n\nFill in the dots (1x).",">"],
    ["Context Free Grammar (CFG): \nSome Context Free Languages (CFL) aren’t r.., meaning they cannot be defined by regular expressions. \nE.g.: {0^n 1^n | n > 0}\n\nFill in the dots (1x).","regular"],
    ["Context Free Grammar (CFG):\nBNF = B...-Naur Form = Programming language grammar style: \n<.> is: variable \n::= is: -> \n| is 'or' \n\nFill in the dots (1x).","Backus"],
    ["Context Free Grammar (CFG):\nBNF = Backus-Naur Form = Programming language grammar style: \n<.> is: v.. \n::= is: -> \n| is 'or' \n\nFill in the dots (1x).","variable"],
    ["Context Free Grammar (CFG):\nBNF = Backus-Naur Form = Programming language grammar style: \n<.> is: variable \n... is: -> \n| is 'or' \n\nFill in the dots (1x).","::="],
    ["Context Free Grammar (CFG):\nBNF = Backus-Naur Form = Programming language grammar style: \n<.> is: variable \n::= is: -> \n... is 'or' \n\nFill in the dots (1x).","|"],
    ["Context Free Grammar (CFG):\nLeft(right)most derivation= \nwAα  =>_lm  wβα, if w is a string of t.. only and A->β is a production. \n\nFill in the dots (1x).","terminals"],
    ["Context Free Grammar (CFG):\nLeft(right)most derivation= \nwAα  =>_...  wβα, if w is a string of t.. only and A->β is a production. \n\nFill in the dots (1x).","lm"],
    ["PushDown Automata (PDA):\n PDA = an ε-NFA (NFA=n..-deterministic finite automaton) with the additional power that it can manipulate a stack. \n\nFill in the dots (1x).","non"],
    ["PushDown Automata (PDA):\n PDA = an ε-NFA (NFA=non-deterministic finite automaton) with the additional power that it can manipulate a s... . \n\nFill in the dots (1x).","stack"],
    ["P... Automata (PDA):\n PDA = an ε-NFA (NFA=non-deterministic finite automaton) with the additional power that it can manipulate a stack. \n\nFill in the dots (1x).","PushDown"],
    ["PushDown Automata (PDA):\nAny PDA can be converted to a Context Free Grammar (CFG), and vice versa. \nIt is proven that they are e.. . \nHowever, PDA’s, being algorithmic, are easier to use than CFG’s when arguing that a language is a CFL. \nE.g. when checking balanced parentheses.\n\nFill in the dots (1x).","equivalent"],
    ["PushDown Automata (PDA):\nPDA’s are e.. to Context Free Grammars (CFG) in language-defining power. \nHowever, PDA's that are nondeterministic can define all Context Free Languages (CFL). \n\nFill in the dots (1x).","equal"],
    ["PushDown Automata (PDA):\nPDA’s are equal to Context Free Grammars (CFG) in language-defining power. \nHowever, only n...ic PDA define all Context Free Languages (CFL). \n\nFill in the dots (1x).","nondeterministic"],
    ["P.. Automata (PDA):\nPDA’s are equal to Context Free Grammars (CFG) in language-defining power. \nHowever, only nondeterministic PDA define all Context Free Languages (CFL). \n\nFill in the dots (1x).","PushDown"],
    ["PushDown Automata (PDA):\n Deterministic version models parsers, and most programming languages use d..ic PDA’s. \n\nFill in the dots (1x).","deterministic"],
    ["PushDown Automata (PDA):\nA PDA is described by: \n1. A finite set of s.. (Q). \n2. An input alphabet (Σ). \n3. A stack alphabet (Γ). \n4. A transition f.. (δ). \n5. A start state (q_0, in Q). \n6. A start symbol (Z_0, in Γ). \n7. A set of final states (F ⊆ Q). \n\nFill in the dots (2x).","states function"],
    ["PushDown Automata (PDA):\nA PDA is described by: \n1. A finite set of states (Q). \n2. An input a.. (Σ). \n3. A stack alphabet (Γ). \n4. A transition function (δ). \n5. A s.. state (q_0, in Q). \n6. A start symbol (Z_0, in Γ). \n7. A set of final states (F ⊆ Q). \n\nFill in the dots (2x).","alphabet start"],
    ["PushDown Automata (PDA):\nA PDA is described by: \n1. A finite set of states (Q). \n2. An input alphabet (Σ). \n3. A s.. alphabet (Γ). \n4. A transition function (δ). \n5. A start state (q_0, in Q). \n6. A start s.. (Z_0, in Γ). \n7. A set of final states (F ⊆ Q). \n\nFill in the dots (2x).","stack symbol"],    
    ["PushDown Automata (PDA):\nA PDA is described by: \n1. A finite set of states (...). \n2. An input alphabet (Σ). \n3. A stack alphabet (Γ). \n4. A transition function (δ). \n5. A start state (q_0, in Q). \n6. A start symbol (Z_0, in Γ). \n7. A set of final states (... ⊆ Q). \n\nFill in the dots (2x).","Q F"],
    ["PushDown Automata (PDA) Terminology:\n a, b, are i.. symbols (sometimes we allow ε). \nX, Y, Z are stack symbols. \nw, x, y, z are s..s of input symbols. \nα, β, are strings of stack symbols. \n\nFill in the dots (2x).","input strings"],
    ["PushDown Automata (PDA) Terminology:\n a, b, are input symbols (sometimes we allow ε). \nX, Y, Z are s.. symbols. \nw, x, y, z are strings of input symbols. \nα, β, are s.. of stack symbols. \n\nFill in the dots (2x).","stack strings"],
    ["PushDown Automata (PDA):\nIn each move/choice, the PDA can: \n1. Change state, and also \n2. Replace the top symbol on the stack by a sequence of 0 (‘pop’) or more symbols (‘...’). \n\nFill in the dots (1x).","pushes"],
    ["PushDown Automata (PDA):\nIn each move/choice, the PDA can: \n1. C.. state, and also \n2. R.. the top symbol on the stack by a sequence of 0 (‘pop’) or more symbols (‘pushes’). \n\nFill in the dots (2x).","Change Replace"],
    ["PushDown Automata (PDA):\nIn each move/choice, the PDA can: \n1. Change state, and also \n2. Replace the top symbol on the stack by a sequence of 0 (‘pop’) or more s.. (‘pushes’). \n\nFill in the dots (1x).","symbols"],
    ["PushDown Automata (PDA):\nTransition function δ has 3 arguments: \n1. A state, ... in Q. \n2. An input, which is either a symbol a in Σ or ε. \n3. A stack symbol in Γ (=stack alphabet). \n\nδ(q,a,Z) is a set of ≥0 actions, which have the form (p,α) in which p is a s... and α is a string of stack symbols (e.g. XYZ).\n\nFill in the dots (2x).","q state"],
    ["PushDown Automata (PDA):\nTransition function δ has 3 arguments: \n1. A state, q in Q. \n2. An i.. , which is either a symbol a in Σ or ε. \n3. A stack symbol in Γ (=stack alphabet). \n\nδ(q,a,Z) is a set of ≥0 actions, which have the form (p,α) in which p is a state and α is a string of s... symbols (e.g. XYZ).\n\nFill in the dots (2x).","input stack"],
    ["PushDown Automata (PDA):\nTransition function δ has 3 arguments: \n1. A state, q in Q. \n2. An input, which is either a s.. a in Σ or ε. \n3. A stack symbol in Γ (=stack alphabet). \n\nδ(q,a,Z) is a set of ≥0 a.., which have the form (p,α) in which p is a state and α is a string of stack symbols (e.g. XYZ).\n\nFill in the dots (2x).","symbol actions"],
    ["PushDown Automata (PDA):\nExample Design of a PDA that accepts {0^n 1^n|n>1}: \nδ(q,0,Z0)={(q, XZ0)} and δ(q,0,X)={(q, XX)} cause one X to be pushed onto the stack for each ... read from the input. \nAnd δ(q,1,X)={(p,ε)} is: go to state p and pop one ... , when 1 is read.\n\nFill in the dots (2x).","0 X"],
    ["PushDown Automata (PDA):\nExample Design of a PDA that accepts {0^n 1^n|n>1}: \nδ(q,0,Z0)={(q, XZ0)} and δ(q,0,X)={(q, XX)} cause one ... to be pushed onto the stack for each 0 read from the input. \nAnd δ(q,1,X)={(p,ε)} is: go to state p and pop one X, when ... is read.\n\nFill in the dots (2x).","X 1"],
    ["PushDown Automata (PDA):\nExample Design of a PDA that accepts {0^n 1^n|n>1}: \nδ(q,0,Z0)={(q, XZ0)} and δ(q,0,X)={(q, XX)} cause one X to be pushed onto the s.. for each 0 read from the input. \nAnd δ(q,1,X)={(p,ε)} is: go to state ... and pop one X, when 1 is read.\n\nFill in the dots (2x).","stack p"],
    ["PushDown Automata (PDA):\nDeterministic PDA = ≤ 1 choice of m.. for any state q, input symbol a, and stack symbol X. \nIn addition, δ(q,a,X) and δ(q,ε,X) cannot both be n.. . \n\nFill in the dots (2x).","move nonempty"],
    ["PushDown Automata (PDA):\nDeterministic PDA = ≤ ... choice of move for any state q, input symbol a, and stack symbol X. \nIn addition, δ(q,a,X) and δ(q,ε,X) cannot b.. be nonempty. \n\nFill in the dots (2x).","1 both"],
    ["PushDown Automata (PDA):\nID = I..eous description = formalization of a PDA process = a triple (q, w, α), where: \nq is the current state, \nw is the r.. input, \nα is the stack contents.\n\nFill in the dots (2x).","Instantaneous remaining"],
    ["PushDown Automata (PDA):\nID = Instantaneous description = formalization of a PDA process = a triple (q, w, α), where: \nq is the c.. state, \nw is the remaining input, \nα is the stack c..s .\n\nFill in the dots (2x).","current contents"],
    ["PushDown Automata (PDA):\nI ⊦ J means that ID I can become ID J in ... move of the PDA. \nFormally: (q, aw, Xα) ⊦ (p, w, βα) for any w and α, if δ(q, a, X) contains (..., β) \n\nFill in the dots (2x).","one p"],
    ["PushDown Automata (PDA):\nI ⊦ J means that ID I can become ID J in one move of the PDA. \nFormally: (q, aw, Xα) ⊦ (..., w, βα) for any w and α, if δ(q, ..., X) contains (p, β) \n\nFill in the dots (2x).","p a"],
    ["PushDown Automata (PDA):\nWe can extend ⊦ to ⊦* (i.e. ≥ ... moves) by: \nBasis: I ⊦*I, and \nInduction: If I⊦*J and J⊦K, then I⊦*... . \n\nFill in the dots (2x).","0 K"],
    ["PushDown Automata (PDA):\nExample of extending ⊦ to ⊦*: \n(q, 000111, Z0)⊦(q, 00111, XZ0)⊦ (q, 0111, XXZ0)⊦(q, ..., XXXZ0)⊦ (p, 11, XXZ0)⊦ (p, 1, Z0)⊦(p, ε, Z0)⊦(f, ε, Z0). \nThus, (q, 000111, Z0)⊦*(f, ε, Z0). \nBut if you would input 0001111 then you would end up with (..., 1, Z0) so the input is not completely consumed, so this string is not accepted.\n\nFill in the dots (2x).","111 f"],
    ["PushDown Automata (PDA):\nLanguage of a PDA named P= L(P) = the set of strings w such that (q0,...,Z0) ⊦* (...,ε,α) for final state f and any string of stack symbols α. \n\nFill in the dots (2x).","w f"],
    ["PushDown Automata (PDA):\nThe e.. s.. language of P = N(P) = also a language of P = \nthe set of strings w such that (q_0,w,Z0) ⊦* (q,ε,ε) for any state q. \n\nFill in the dots (2x).","empty stack"],
    ["PushDown Automata (PDA):\nThe empty stack language of P = N(P) = also a language of P = \nthe set of strings w such that (q_0,w,Z0) ⊦* (q,ε,ε) for any s.. q. \n\nFill in the dots (1x).","state"],
    ["PushDown Automata (PDA):\nIf L = L(P), then there is another PDA P' such that ... = N(P'). \nAnd if L = N(P), then there is another PDA P'' such that L = L(P''). \nIntuition: P' and P'' use a bottom marker symbol X_0 to catch the case where P e.. its stack.\n\nFill in the dots (2x).","L empties"],
    ["PushDown Automata (PDA):\nIf L = L(P), then there is another PDA P' such that L = N(P'). \nAnd if L = N(P), then there is another PDA P'' such that ... = L(P''). \nIntuition: P' and P'' use a bottom marker symbol X_0 to c.. the case where P empties its stack.\n\nFill in the dots (2x).","L catch"],
    ["PushDown Automata (PDA):\nThere are methods to c.. any PDA to a Context Free Grammar (CFG), and vice versa. \nIt is proven that they are equivalent. \nHowever, PDA’s, being a..ic, are easier to use than CFG’s when arguing that a language is a CFL. \nE.g. when checking balanced parentheses.\n\nFill in the dots (2x).","convert algorithmic"],
